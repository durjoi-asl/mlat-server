...
def mlat(replies, altitude):
    ...
    # print("Sorted Replies: ")
    # print(sorted_replies)
    ...
    # print('Station related to first Station: ')
    # print(rel_stations)
...
if __name__ == '__main__':
    ...
    teststations = [[23.83588, 90.41611, 100], [22.35443, 91.83392, 20], [23.837338, 89.53937, 100], [22.437338, 90.33937, 10]]
    testalt      = 9050
    testplane    = numpy.array(llh2ecef([22.90597, 90.12725, testalt]))
    ...
    # teststamps   = [20, 20.0000841, 20.00005445]
    ...
    print("Test Plane: 22.90597 90.12725 9050")
    print(f"Calculated Location: {ans}")
